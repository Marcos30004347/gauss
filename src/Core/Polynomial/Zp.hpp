...
std::pair<ast::AST*, ast::AST*> divideGPE_Zp(ast::AST* u, ast::AST* v, ast::AST* x, int p);
...
std::vector<ast::AST*> extendedEuclideanAlgGPE_Zp(ast::AST* u, ast::AST* v, ast::AST* x, int p);

std::pair<ast::AST*, ast::AST*> divideGPE_Sp(ast::AST* u, ast::AST* v, ast::AST* x, int p);
...
std::vector<ast::AST*> extendedEuclideanAlgGPE_Sp(ast::AST* u, ast::AST* v, ast::AST* x, int p);
