...
*** Creation of algebraic expressions:
		#+begin_src C++
			...
			#include <gaussAlgebra/Expression.hpp>
...
*** Calculus:
		Currently the system is only capable of taking the derivatives of elementary functions and polynomials. Check gaussCalculus/Derivative.hpp for more information.
