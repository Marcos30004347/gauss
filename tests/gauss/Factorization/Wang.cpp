...
void should_solve_diophant_poly_expr() {
  ...
  expr H1 = list({polyExpr(44 * pow(x, 2) + 42 * x + 1, L1),
                  polyExpr(126 * pow(x, 2) + -9 * x + 28, L1),
                  polyExpr(187 * pow(x, 2) + -23, L1)});

  expr H2 =
      list({polyExpr(-4 * pow(x, 2) * y + -12 * pow(x, 2) + -3 * x * y + 1, L2),
  ...
  expr c1 = polyExpr(-70686 * pow(x, 5) + -5863 * pow(x, 4) +
                         -17826 * pow(x, 3) + 2009 * pow(x, 2) + 5031 * x + 74,
                     L1);

  expr c2 = polyExpr(9 * pow(x, 5) * pow(y, 4) + 12 * pow(x, 5) * pow(y, 3) +
  ...
  expr c3 =
      polyExpr(-36 * pow(x, 4) * pow(y, 2) + -108 * pow(x, 4) * y +
                   -27 * pow(x, 3) * pow(y, 2) + -36 * pow(x, 3) * y +
                   -108 * pow(x, 3) + -8 * pow(x, 2) * pow(y, 2) +
                   -42 * pow(x, 2) * y + -6 * x * pow(y, 2) + 9 * x + 2 * y,
               L2);
  ...
  expr R2 =
      list({polyExpr(-1 * x * y, L2), polyExpr(-3 * x, L2), polyExpr(-6, L2)});
...
void should_get_lead_coeffs_poly_expr() {
  ...
  expr F = list({polyExpr(y, R), polyExpr(z, R), polyExpr(y + z, R),
                 polyExpr(y + -z, R)});
  ...
  assert(wlc[1].size() == 3);
  expr S = set({polyExpr(187 * pow(x, 2) + -23, T),
                polyExpr(44 * pow(x, 2) + 42 * x + 1, T),
                polyExpr(126 * pow(x, 2) + -9 * x + 28, T)});
  expr Q = set({
      wlc[1][0],
      wlc[1][1],
      wlc[1][2],
...
void should_factorize_multivariate_polynomials_poly_expr() {
  ...
  expr U5 = factorsPolyExpr(polyExpr(pow(x, 2) * pow(y, 2) * pow(z, 2) + -9, T),
                            T, K);

  printf("\n\n-----> U5 = %s\n\n", to_string(U5).c_str());
  expr E = list({x, y, z, u});

  expr U6 = factorsPolyExpr(
      polyExpr(pow(x, 2) * pow(y, 2) * pow(z, 2) * pow(u, 2) + -9, E), E, K);
  ...
  expr u7 =
      ...
      pow(x, 5) * pow(y, 4) * pow(z, 3) + 12 * pow(x, 5) * pow(y, 3) * z +
      -1 * pow(x, 5) * pow(y, 2) * pow(z, 5) +
      12 * pow(x, 5) * pow(y, 2) * pow(z, 2) + -12 * pow(x, 5) * y * pow(z, 3) +
      -12 * pow(x, 5) * pow(z, 4) + 8 * pow(x, 4) * pow(y, 4) +
      6 * pow(x, 4) * pow(y, 3) * pow(z, 2) + 8 * pow(x, 4) * pow(y, 3) * z +
      -4 * pow(x, 4) * pow(y, 2) * pow(z, 4) +
      4 * pow(x, 4) * pow(y, 2) * pow(z, 3) +
      -8 * pow(x, 4) * pow(y, 2) * pow(z, 2) + -4 * pow(x, 4) * y * pow(z, 5) +
      -2 * pow(x, 4) * y * pow(z, 4) + -8 * pow(x, 4) * y * pow(z, 3) +
      2 * pow(x, 3) * pow(y, 4) * z + pow(x, 3) * pow(y, 3) * pow(z, 3) +
      -1 * pow(x, 3) * pow(y, 2) * pow(z, 5) +
      -2 * pow(x, 3) * pow(y, 2) * pow(z, 3) + 9 * pow(x, 3) * pow(y, 2) * z +
      -12 * pow(x, 3) * y * pow(z, 3) + 12 * pow(x, 3) * y * pow(z, 2) +
      -12 * pow(x, 3) * pow(z, 4) + 3 * pow(x, 3) * pow(z, 3) +
      6 * pow(x, 2) * pow(y, 3) + -6 * pow(x, 2) * pow(y, 2) * pow(z, 2) +
      8 * pow(x, 2) * pow(y, 2) * z + -2 * pow(x, 2) * y * pow(z, 4) +
      -8 * pow(x, 2) * y * pow(z, 3) + 2 * pow(x, 2) * y * pow(z, 2) +
  ...
  printf("\n\n-----> U7 = %s\n\n", to_string(U7).c_str());
	...
	expr _U7 = factorPolyExprAndExpand(polyExpr(u7, T), T, K);
...
void should_lift_factors_poly_expr() {
  ...
  expr U = list({polyExpr(44 * pow(x, 2) + 42 * x + 1, list({x})),
                 polyExpr(126 * pow(x, 2) + -9 * x + 28, list({x})),
                 polyExpr(187 * pow(x, 2) + -23, list({x}))});

  expr LC = list({polyExpr(-4 * y + -4 * z, rest(L)),
